...
import scovmod.model.transition.infected.ExposedToRecoveredTransitionExecutor;
import scovmod.model.util.math.Random;

import static org.mockito.Mockito.*;

public class ExposedToRecoveredVariantTransitionExecutorTest {
    ...
    public void youngPerson_CAN_Transition(){
        ...
        when(params.geteToR_YoungRate_covidVariant()).thenReturn(E_TO_R_RATE);

        ExposedToRecoveredVariantTransitionExecutor instance = new ExposedToRecoveredVariantTransitionExecutor(sm, rnd, TIMESTEP, params,slaac);
    ...
    public void adultPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.geteToR_AdultRate_covidVariant()).thenReturn(E_TO_R_RATE);
    ...
    public void elderlyPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.geteToR_ElderlyRate_covidVariant()).thenReturn(E_TO_R_RATE);
