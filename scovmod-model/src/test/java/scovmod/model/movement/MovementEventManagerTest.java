...
public class MovementEventManagerTest {
    ...
    public void resolveMovementsThenDelegateTsoMover(){
        ...
        when(resolver.apply(incoming1,intSetOf(),intSetOf(),intSetOf(),intSetOf(),intSetOf(),intSetOf())).thenReturn(movements1);
        when(resolver.apply(incoming2,intSetOf(),intSetOf(),intSetOf(),intSetOf(),intSetOf(),intSetOf())).thenReturn(movements2);

        MovementEventManager instance = new MovementEventManager(resolver, mover);
        instance.doMovements(TestUtils.setOf(incoming1, incoming2),intSetOf(),intSetOf(),intSetOf(),intSetOf(),intSetOf(),intSetOf());
