...
public class TracedToDeadTransitionExecutorTest {
...
//    DeathRates dr;
    ...
    public void youngPerson_CAN_Transition(){
        ...
        when(params.gettToD_YoungRate()).thenReturn(T_TO_D_RATE);
       // when(dr.getDeathRateModifierBasedOnHealthIndex(PERSON_1)).thenReturn(DEATH_RATE_MODIFICATION);

        TracedToDeadTransitionExecutor instance = new TracedToDeadTransitionExecutor(sm, rnd, TIMESTEP, params,slaac/*, dr*/);
    ...
    public void adultPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.gettToD_AdultRate()).thenReturn(T_TO_D_RATE);
       // when(dr.getDeathRateModifierBasedOnHealthIndex(PERSON_1)).thenReturn(DEATH_RATE_MODIFICATION);
    ...
    public void elderlyPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.gettToD_ElderlyRate()).thenReturn(T_TO_D_RATE);
       // when(dr.getDeathRateModifierBasedOnHealthIndex(PERSON_1)).thenReturn(DEATH_RATE_MODIFICATION);
