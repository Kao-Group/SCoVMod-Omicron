...
public class NationalRecoveredSamplerTest {
    ...
    @Mock
    WithinGroupRecoveredSampler asbg;
    ...
    private NationalRecoveredSampler instance;
    ...
    public void sampleAnimals(){
        ...
        when(rsgs.getNumberRecoveredSeedsPerGroupMap()).thenReturn(multinomialTrialResult);
        ...
        instance = new NationalRecoveredSampler(rsgs, asbg, peopleByLocation);
