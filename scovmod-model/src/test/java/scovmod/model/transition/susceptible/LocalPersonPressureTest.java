...
public class LocalPersonPressureTest {
    ...
    public void mutatePersonPressureMap() {
        ...
        when(br.getBeta(InfectionState.MILD_INFECTIOUS_ADULT,LOCATION_1)).thenReturn(MI_RATE);
        when(br.getBeta(InfectionState.MILD_INFECTIOUS_ADULT,LOCATION_2)).thenReturn(MI_RATE);
        when(br.getBeta(InfectionState.SEVERE_INFECTIOUS_ELDERLY,LOCATION_1)).thenReturn(SI_RATE);
        when(br.getBeta(InfectionState.SEVERE_INFECTIOUS_ELDERLY,LOCATION_2)).thenReturn(SI_RATE);
