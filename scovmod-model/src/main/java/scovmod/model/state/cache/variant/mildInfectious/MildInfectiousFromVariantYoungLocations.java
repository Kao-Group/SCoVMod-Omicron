...
import static scovmod.model.state.infection.InfectionState.MILD_INFECTIOUS_YOUNG_VARIANT;

public class MildInfectiousFromVariantYoungLocations implements Cache {

    IntSet locations = new IntOpenHashSet();

    public void wholeLocationUpdate(int locationId, LocalPopulation population) {
        if (!population.getAllInState(MILD_INFECTIOUS_YOUNG_VARIANT).isEmpty()) {
    ...
    public IntSet getMildInfectiousFromVariantYoungLocations() {
