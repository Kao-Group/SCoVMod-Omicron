...
public class DailyResult implements Comparable<DailyResult>{
    ...
    private final CouncilAreaAllStatesValueType type;
    private final int councilAreaID;
    public DailyResult(LocalDate date, CouncilAreaAllStatesValueType type, int councilAreaID){
        this.date = date;
        this.type = type;
    ...
    public CouncilAreaAllStatesValueType getType() {
        return type;
    }
 ...
 */
    ...
    public int compareTo(DailyResult dailyResult) {
        return Comparator.comparing(DailyResult::getType)
                .thenComparing(DailyResult::getCouncilAreaID)
