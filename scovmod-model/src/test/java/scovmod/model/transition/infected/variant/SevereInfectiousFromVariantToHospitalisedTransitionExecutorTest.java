...
import scovmod.model.transition.infected.SevereInfectiousToHospitalisedTransitionExecutor;
import scovmod.model.util.math.Random;

import static org.mockito.Mockito.*;

public class SevereInfectiousFromVariantToHospitalisedTransitionExecutorTest {
    ...
    public void youngPerson_CAN_Transition(){
        ...
        when(params.getSiToH_YoungRate_covidVariant()).thenReturn(SI_TO_H_RATE);

        SevereInfectiousFromVariantToHospitalisedTransitionExecutor instance = new SevereInfectiousFromVariantToHospitalisedTransitionExecutor(sm, rnd, TIMESTEP, params,slaac);
    ...
    public void adultPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.getSiToH_AdultRate_covidVariant()).thenReturn(SI_TO_H_RATE);
    ...
    public void elderlyPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.getSiToH_ElderlyRate_covidVariant()).thenReturn(SI_TO_H_RATE);
