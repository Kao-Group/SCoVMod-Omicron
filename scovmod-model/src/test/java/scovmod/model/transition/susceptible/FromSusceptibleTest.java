...
public class FromSusceptibleTest {
    ...
    public void setup(){
        ...
        instance = new FromSusceptible(lap, lvp, vp, te);
    }


    @Test
    public void addPressureFromMainStrainAndVariant() {
	    Set<LocationIncomingPersons> setOfIncomingPersons = setIncomingPersons;

        instance.doTransitions(setOfIncomingPersons);

        InOrder inOrder = inOrder(vp, lap, lvp, te);
        ...
        inOrder.verify(lvp).addLocalVariantPressure(same(locationPressure));
