...
import scovmod.model.transition.infected.MildInfectiousToSevereTransitionExecutor;
import scovmod.model.util.math.Random;

import static org.mockito.Mockito.*;

public class MildInfectiousToSeverInfectiousVariantTransitionExecutorTest {
    ...
    public void youngPerson_CAN_Transition(){
        ...
        when(params.getMiToSI_YoungRate_covidVariant()).thenReturn(MI_TO_SI_RATE);

        MildInfectiousToSevereVariantTransitionExecutor instance = new MildInfectiousToSevereVariantTransitionExecutor(sm, rnd, TIMESTEP, params,slaac);
        ...
        verify(sm).updateInfectionState(PERSON_1, InfectionState.SEVERE_INFECTIOUS_YOUNG_VARIANT);
    ...
    public void adultPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.getMiToSI_AdultRate_covidVariant()).thenReturn(MI_TO_SI_RATE);
        ...
        verify(sm).updateInfectionState(PERSON_1, InfectionState.SEVERE_INFECTIOUS_ADULT_VARIANT);
        verifyNoMoreInteractions(sm);
    }
    ...
    public void elderlyPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.getMiToSI_ElderlyRate_covidVariant()).thenReturn(MI_TO_SI_RATE);
        ...
        verify(sm).updateInfectionState(PERSON_1, InfectionState.SEVERE_INFECTIOUS_ELDERLY_VARIANT);
        verifyNoMoreInteractions(sm);
    }
