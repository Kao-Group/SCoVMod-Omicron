...
public class Initialiser {
    ...
    private InitialiseToRecoveredManager itrm;
    ...
    public Initialiser(
            ...
            InitialSeeder is,
            SeedManager sm,
            InitialiseToRecoveredManager itrm) {
    ...
    public void seedPeople(ConfigParameters params, int stochasticIncrement) {
        ...
        // Set some of the population to recovered
        itrm.initialiseRecoveredPeople(peopleByLocation);
