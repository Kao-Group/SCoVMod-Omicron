...
import scovmod.model.output.modules.councilareaAllStates.{CouncilAreaAllStatesSummary, CouncilAreaAllStatesSummaryResult, DailyResult}
...
case object FitAssessmentCALevelAllStates extends Task {
  ...
  def runModel(runId: Int, particleWriterCSV: BufferedWriter, job: Job): Unit = {
    import job._
    val out = new CouncilAreaAllStatesSummary;
    ...
    val dailySimCommunityResult = simulated.asInstanceOf[CouncilAreaAllStatesSummaryResult]
