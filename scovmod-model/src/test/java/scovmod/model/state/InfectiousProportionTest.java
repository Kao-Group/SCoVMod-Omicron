...
public class InfectiousProportionTest {
    ...
    private static final int PERSON_1_4 = 1004;
    ...
    public void emptyCacheOfPreviousLocationProportions(){
        ...
        FakeLocalPopulation updatedPop2 = new FakeLocalPopulation();
        updatedPop2.testSet(PERSON_1_4, MILD_INFECTIOUS_ELDERLY_VARIANT);

        StateQuery sq = mock(StateQuery.class);
        when(sq.getCopyOfLocalPopulation(LOCATION_1)).thenReturn(pop, updatedPop,updatedPop2);
        ...
        assertEquals(1.0 / 1.0, instance.inCommunity(LOCATION_1,MILD_INFECTIOUS_ELDERLY), TOL);
        assertEquals(1.0 / 3.0, instance.inCommunity(LOCATION_1,SEVERE_INFECTIOUS_ELDERLY), TOL);
        assertEquals(1.0 / 1.0, instance.inCommunity(LOCATION_1,MILD_INFECTIOUS_ELDERLY_VARIANT), TOL);
    }
