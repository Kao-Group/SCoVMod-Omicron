...
import scovmod.model.transition.infected.HospitalisedToRecoveredTransitionExecutor;
import scovmod.model.util.math.Random;

import static org.mockito.Mockito.*;

public class HospitalisedToRecoveredVariantTransitionExecutorTest {
    ...
    public void youngPerson_CAN_Transition(){
        ...
        when(params.gethToR_YoungRate_covidVariant()).thenReturn(H_TO_R_RATE);

        HospitalisedToRecoveredVariantTransitionExecutor instance = new HospitalisedToRecoveredVariantTransitionExecutor(sm, rnd, TIMESTEP, params,slaac);
    ...
    public void adultPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.gethToR_AdultRate_covidVariant()).thenReturn(H_TO_R_RATE);
    ...
    public void elderlyPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.gethToR_ElderlyRate_covidVariant()).thenReturn(H_TO_R_RATE);
