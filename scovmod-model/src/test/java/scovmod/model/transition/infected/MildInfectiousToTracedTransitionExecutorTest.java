...
public class MildInfectiousToTracedTransitionExecutorTest {
    ...
    public void youngPerson_CAN_Transition(){
        ...
        when(params.getMiToT_YoungRate()).thenReturn(MI_TO_T_RATE);
        ...
        MildInfectiousToTracedTransitionExecutor instance = new MildInfectiousToTracedTransitionExecutor(sm, rnd, TIMESTEP, params,slaac, tr, sq);
    ...
    public void adultPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.getMiToT_AdultRate()).thenReturn(MI_TO_T_RATE);
        when(sq.getPersonLocation(PERSON_1)).thenReturn(LOCATION_1);
        when(tr.getTracingRate(MI_TO_T_RATE,LOCATION_1)).thenReturn(MI_TO_T_RATE);
    ...
    public void elderlyPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.getMiToT_ElderlyRate()).thenReturn(MI_TO_T_RATE);
        when(sq.getPersonLocation(PERSON_1)).thenReturn(LOCATION_1);
        when(tr.getTracingRate(MI_TO_T_RATE,LOCATION_1)).thenReturn(MI_TO_T_RATE);
