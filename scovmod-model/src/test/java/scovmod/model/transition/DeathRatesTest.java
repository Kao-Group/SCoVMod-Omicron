...
//import scovmod.model.input.DeprivationIndexPerCouncilArea;
...
//    StateQuery sq;
//    @Mock
//    DeprivationIndexPerCouncilArea diph;
//    @Mock
...
//        when(diph.getDeprivationIndexPerCA()).thenReturn(deprivationIndex);
