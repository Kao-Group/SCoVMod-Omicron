...
public class TracedToHospitalisedTransitionExecutorTest {
    ...
    public void youngPerson_CAN_Transition(){
        ...
        when(params.gettToH_YoungRate()).thenReturn(T_TO_H_RATE);

        TracedToHospitalisedTransitionExecutor instance = new TracedToHospitalisedTransitionExecutor(sm, rnd, TIMESTEP, params,slaac);
    ...
    public void adultPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.gettToH_AdultRate()).thenReturn(T_TO_H_RATE);
    ...
    public void elderlyPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.gettToH_ElderlyRate()).thenReturn(T_TO_H_RATE);
